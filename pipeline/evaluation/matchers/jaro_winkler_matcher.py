"""Jaro-Winkler similarity-based matcher for relation matching."""
...
class JaroWinklerMatcher(BaseMatcher):
    """Matches relations using Jaro-Winkler similarity."""
    ...
    def __init__(
        ...
        if not JELLYFISH_AVAILABLE:
            self.logger.warning(
                "[JaroWinklerMatcher] jellyfish not available. "
    ...
    def get_config(self) -> dict:
        ...
        return {
            ...
            "method": "jaro_winkler_similarity"
        }
    
    def compute_text_similarity(self, text1: str, text2: str) -> float:
        """
        Compute Jaro-Winkler similarity between two texts with containment checks.
    ...
    def match(
        ...
        """Match predicted relations to gold relations using Jaro-Winkler similarity."""
